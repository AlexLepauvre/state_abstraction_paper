...
participants (N=\texttt{\{python\}\ f"\{n\_participants:.0f\}"})
performed a sequential decision-making task with a large state space
(Ott et al. (2022b), see Figure~\ref{fig-design} and
